...
const ApologySection = () => {
  ...
  const lines = [
    ...
    "အချစ်ရဲ့ အပြုံးတစ်ချက်က ကိုယ့်အတွက် ဥရောပတစ်ခွင်လုံးကို သိမ်းယူခဲ့တဲ့ နပိုလီယံကြီးရဲ့ အောင်မြင်မှုလို တောက်ပလာစေတယ်။",
    ...
    "ထို့အတွက်ကြောင့် ကိုယ်ဟာ အနာဂတ်မှာ ကောင်းမွန်တဲ့ လူတစ်ယောက်အဖြစ် ပြောင်းလဲရင်း",
